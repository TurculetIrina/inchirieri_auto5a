...
namespace inchirieri_auto
{
    class Persoane
    {
        ...
        public string Data()
        {
            return string.Format("{0}, {1}, {2}, {3}, {4}, {5}",
                Nume, Prenume, Adresa, Telefon, Cnp, Varsta);
        }
    ...
    class Angajati: Persoane
    {
        ...
        public Angajati(string _nume, string _prenume, string _adresa, string _telefon, 
    ...
    class Clienti: Persoane
    {
        ...
        public Clienti(string _nume, string _prenume, string _adresa, string _telefon,
